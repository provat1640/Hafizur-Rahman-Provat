	...
	<>
	  ...
	  <header className={styles.header}>
		<div className={styles.container}>
			<h1 className={styles.logo}><Link href="/">Hafizur Rahman</Link></h1>
		  <nav className={styles.nav}>
			...
			<a href="https://github.com/provat1640" target="_blank" rel="noreferrer" aria-label="GitHub" style={{ marginLeft: 12 }}>
